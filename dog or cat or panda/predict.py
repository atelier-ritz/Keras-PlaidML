...
if args["flatten"] > 0:
	image = image.flatten() # convert to a simple vector (array)
	image = image.reshape((1, image.shape[0]))
# otherwise, we must be working with a CNN -- don't flatten the image, simply add the batch dimension
else:
...
preds = model.predict(image) # array([[5.4622066e-01, 4.5377851e-01, 7.7963534e-07]], dtype=float32)
print(preds)
