...
# Image augmentation allows us to construct “additional” training
# data from our existing training data by randomly rotating, shifting,
...
# train the network. we are using fit_generator() instead of fit()
# because we used image augmentation. We must pass the generator
# with our training data as the first parameter. The generator will
# produce batches of augmented training data according to the settings
# we previously made.
